...
import { connexionAgent, obtenirSessionActuelle } from '../services/authService';
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Agent Space</h1>
            <p className="text-gray-600">AyitiShop&Ship</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="agent@ayitishopship.com"
              />
            </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>&copy; 2025 AyitiShop&Ship. Tous droits réservés.</p>
        </div>
      </div>
    </div>
  );
