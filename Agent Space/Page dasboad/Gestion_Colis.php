...
<body>
    ...
    <script>
        ...
        async function handleFormSubmission(e) {
            ...
            try {
                ...
                const response = await fetch("Savecolis.php", {
                method: "POST",
                body: formData
            }).then(res => res.json());
        ...
        async function sendColis(formData) {
            ...
            const numeroSuivi = `ASH-${timestamp}${random}`;
    ...
    const data = {
          destinataire: document.getElementById('destinataire_nom').value,
          ville: document.getElementById('ville_recuperation').value,
          poids: document.getElementById('poids_lbs').value,
...
.section2:last-child {
  border-bottom: none; /* Pas de ligne après la dernière partie */
}


.section {
  padding: 10px;
  border-bottom: 1px solid black; /* Séparation */
}
...
.logo img {
  ...
  <div class="top section">
     <div class="section2">
    <div class="qr">
      <img src="${qrDataURL}" alt="QR Code" width="120">
    </div>
        </div>
    <div class="brand">
       <div class="logo">
  ...
  <div class="middle section">
    ...
    <p><strong>Poids:</strong> ${data.poids} lbs</p>
    <p><strong>Description:</strong> ${data.description}</p>
    <p class="tracking"><strong>Numéro de suivi:</strong> ${currentTrackingNumber}</p>
  </div>

  <!-- Bas -->
  <div class="bottom section">
    <p>Merci d’avoir choisi <strong>AyitiShop&Ship</strong> ✈️</p>
    <p>ayitishopship.com</p>
  </div>
</div>
                </body>
            </html>
